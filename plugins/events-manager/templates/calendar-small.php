 ...
 */
?>
<table class="em-calendar em-calendar-small">
	<thead>
		<tr class="first">
			<td class="first month-name" colspan="5"><?php echo ucfirst(date_i18n(get_option('dbem_small_calendar_month_format'), $calendar['month_start'])); ?></td>
			<td class=""><a class="em-calnav em-calnav-prev" href="<?php echo $calendar['links']['previous_url']; ?>" rel="nofollow"></a></td>
			<td class="last"><a class="em-calnav em-calnav-next" href="<?php echo $calendar['links']['next_url']; ?>" rel="nofollow"></a></td>
		</tr>
	</thead>
	<tbody>
		<tr class="days-names">
		...
		<tr class="days">
			...
			foreach($calendar['cells'] as $date => $cell_data ){
				...
				echo ($col_count == 1 && $count < $cal_count) ? '</tr><tr class="days">':'';
				$count ++; 
			}
			?>
		</tr>
